...
- (void)loadView {
    ...
    self.textLabel.text          = [NSString stringWithFormat:@"Could you please rate your experience with %@ below", self.feedback.location.name];;
    ...
    self.ratingView.emptySelectedImage = [UIImage imageNamed:@"rpf-star"];
    self.ratingView.fullSelectedImage  = [UIImage imageNamed:@"rpf-star-unselected"];
...
- (void)layoutRatingView {
    ...
    UIImage *starImage = [UIImage imageNamed:@"rpf-star"];
...
- (void)helpTheViewsForRatingView:(TPFloatRatingView *)ratingView rating:(NSInteger)rating {
    ...
    if(rating <= 1.0) {
        ...
        placeHolderText
        = @"Could you please tell us a little more. For example, what made this a negative experience?";
    } else if(rating == 2.0) {
        placeHolderText
        = @"Could you please tell us a little more. For example, what made this a negative experience?";
    } else if(rating == 3.0) {
        placeHolderText
        = @"Can you please tell us how we can improve the experience that you encountered?";
    } else if(rating == 4.0) {
        placeHolderText
        = @"Could you please tell us a little more. For example, could you possibly tell us what you liked most about your experience?";
    } else {
        placeHolderText
        = @"Could you please tell us a little more. For example, could you possibly tell us what you liked most about your experience?";
    }
    ...
    if(hideUserInformationFields == YES
       ...
       && self.feedback.fullName.length > 0) {
        ...
        if(self.nameTextField == nil) {
            ...
            self.nameTextField.text               = self.feedback.fullName;
        ...
        if(self.emailTextField == nil) {
            ...
            self.emailTextField.text               = self.feedback.emailAddress;
